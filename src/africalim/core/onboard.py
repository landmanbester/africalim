...
────────────────────────────────────────────────────────────────────────────────
  ...
  Push your project to GitHub:
    ...
    gh repo create landmanbester/africalim --public --source=. --push

  Or create the repo manually at https://github.com/new and push:

    git remote add origin git@github.com:landmanbester/africalim.git
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Scroll down to "Add a new pending publisher" and fill in:
    PyPI project name: africalim
    Owner:             landmanbester
    Repository:        africalim
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/africalim/settings/environments
...
────────────────────────────────────────────────────────────────────────────────
  ...
  a) Create the app:
     ...
     Settings:
       Name:        africalim-bot (or any name you like)
       Homepage:    https://github.com/landmanbester/africalim
  ...
  d) Add secrets to your repository:
     ...
     Go to: https://github.com/landmanbester/africalim/settings/secrets/actions
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/africalim/settings/rules
...
────────────────────────────────────────────────────────────────────────────────
  ...
  The container image is stored in src/africalim/_container_image.py
  ...
  When you create a feature branch:
    ...
    1. Edit src/africalim/_container_image.py and change the tag:

         CONTAINER_IMAGE = "ghcr.io/landmanbester/africalim:my-feature"
